/** English and Dutch copy for the thesis narrative site. */
export const translations = {
  en: {
    metaTitle: 'Women’s economic autonomy in the Dutch Republic and maritime-induced male absence · Take Watanabe',
    metaDescription:
      'This thesis studies the causal effect of maritime-induced male absence on women’s economic autonomy in the early-modern Dutch Republic.',
    navAria: 'Chapters',
    langAria: 'Language',
    ...
    navObserve: 'Conceptual framework and data sources',
    navIntensity: 'Data and treatment intensity',
    navCompare: 'Empirical strategy',
    ...
    heroBegin: 'Follow the evidence',
    heroPdf: 'Download PDF',
    heroFindingsAria: 'What the evidence suggests',
    heroFindingsEyebrow: 'Abstract',
    heroEstimateAria:
      '2.84 percentage points: estimated smaller literacy gender gap by 1750 per one standard deviation higher VOC departure intensity, with geography controls',
    heroEstimateNumber: '2.84',
    heroEstimateUnit: 'pp',
    heroEstimateLabel: 'Decrease in the literacy gender gap per 1 SD increase in seafarer departures',
    ...
    heroCaveatAria: 'The results are highly robust to population growth controls and less robust to a leave-one-out test',
    heroCaveatLabel: 'Robustness',
    heroCaveatText: 'The results are highly robust to population growth controls and less robust to a leave-one-out test.',
    settingEyebrow: 'Introduction',
    ...
    globeZoomIn: 'Zoom in',
    globeZoomOut: 'Zoom out',
    globeTypeCorridor: 'Recurring corridor',
    globeTypeVoyage: 'Documented voyage',
    globePeriodLabel: 'Period',
    globeStopsLabel: 'Documented places',
    ...
    globeRouteBatavia: 'Batavia, 1628–29',
    globeRouteBataviaDesc:
      'The VOC ship Batavia departed Texel for Java, rounded the Cape, sailed too far east on the southern-ocean corridor and wrecked at Houtman Abrolhos on 4 June 1629.',
    globeRouteJapan: 'Batavia to Japan',
    globeRouteJapanDesc:
      'VOC trade with Japan was administered from Batavia, first through Hirado and later Dejima, with shipping passing north through the South China and East China seas.',
    ...
    globePlaceBatavia: 'Batavia (Jakarta)',
    globePlaceAbrolhos: 'Houtman Abrolhos',
    globePlaceFormosa: 'Formosa (Taiwan)',
    ...
    settingP3:
      'To my knowledge, no quantitative work exists on why the economic autonomy of Dutch women seemed higher than in other countries at the time. Moreover, none of the reviewed literature has studied the effects of prolonged male absence caused by a peacetime context rather than a wartime context.',
    questionEyebrow: 'Research question',
    questionH2: 'Maritime-induced male absence and women’s economic autonomy',
    questionPull:
      'How did prolonged and permanent male absence resulting from voyages of the Dutch East India Company affect women’s economic autonomy in the early-modern Dutch Republic?',
    questionP1Html:
      'This presents an interesting historical <strong>natural experiment</strong> to study from a gendered perspective. While the general effects on the Dutch Republic’s economic prosperity are well known, little is known about the marginalised groups at home, and along gender lines, the group of interest is Dutch women.',
    questionPreviewHtml:
      'Through a continuous difference-in-differences design, I exploit variation in the literacy gender gap and seafarer departures across Dutch cities as measures for respectively women’s economic autonomy and maritime-induced male absence.',
    observeEyebrow: 'Conceptual framework and data sources',
    observeH2: 'The literacy gender gap as a measure of economic autonomy',
    observeP1Html:
      'To analyse women’s economic autonomy in the Dutch Republic, I use the gap between female and male literacy as an <strong>observable proxy outcome</strong>, which I argue is sufficiently representative of economic autonomy. Studying the literacy gender gap signals the relative economic position of women and men, which thus forms a crude yet sufficient proxy for economic autonomy.',
    observeP2:
      'Data on female and male literacy rates in the Dutch Republic are provided by Akçomak, Webbink, and ter Weel (2016), who aggregated literacy rates at the city level by differentiating between hand signatures and simple marks of brides and grooms in the Amsterdam Marriage Registers as a proxy for literacy. The place of former residence was registered in the records, allowing for literacy rates to be traced back to the cities from which the bride and the groom originated.',
    observeP3:
      'The ability to read and write was essential for attaining higher-level positions inside the maritime sector, which correspondingly would come with higher wages. More generally yet also more specifically for women, literacy also aided women in running or taking over businesses of their parent or spouse.',
    gapAlt:
      'Line chart of mean male and female literacy from 1600 to 1750; the shaded gender gap narrows from 33.2 to 25.6 percentage points',
    gapCaption:
      'The 32 Dutch cities start with a substantial literacy gender gap, which narrows over time primarily due to a mean increase in female literacy and a decrease in its variance across the cities, outpacing the concurrent increase in male literacy.',
    gapX: 'Year',
    gapY: 'Mean literacy (%)',
    ...
    gapTooltipGap: 'Gender gap',
    intensityEyebrow: 'VOC departure intensity',
    intensityH2: 'Data on literacy rates, VOC employee records and city populations',
    intensityPHtml:
      'To construct a continuous exposure measure to maritime-induced male absence, I use the enriched <strong>VOC seafarers dataset</strong>, which is constructed from 774,200 muster records of seafarers in the Dutch East India Company from 1633 to 1794 (Petram et al., 2024). I filter for disambiguated people and whether the place and date of their first departure is registered. Seafarer departures are aggregated into treatment intensity per city from 1633 to 1750 and normalised in relation to a city’s initial size.',
    mapAlt: 'Stylized Dutch Republic map from thesis GIS outline, with Zuiderzee and Zeeland islands; circle size shows VOC departure intensity, Rotterdam highlighted',
    mapCaption:
      'The geographical distribution of the 32 cities shows that the sample is mostly evenly spread across the Dutch Republic. Most notably, Amsterdam’s literacy rates by gender are not present in the dataset. Nevertheless, the sample still contains a sufficient representation of western cities such as Rotterdam and Leiden, which benefited from the VOC.',
    intensityLegend: 'VOC departure intensity',
    mapLower: 'Lower',
    mapHigher: 'Higher',
    mapTooltipIntensity: 'VOC departure intensity',
    histAlt: 'Histogram of VOC departure intensity across 32 Dutch cities, with Rotterdam in the right tail',
    histCaption:
      'Few of the 32 cities can be considered true control units or as good as untreated. All cities have some level of seafarer departures over a century-long period, explaining why binary distinctions between untreated and treated groups of cities are infeasible. A notable outlier is Rotterdam, which causes a right-skewed treatment distribution.',
    histX: 'VOC departure intensity (departures ÷ 1600 population)',
    histY: 'Number of cities',
    histCities: 'Cities',
    histRotterdam: 'Rotterdam bin',
    histTooltipCount: 'Cities in bin',
    compareEyebrow: 'Maritime-induced male absence and the literacy gender gap',
    compareH2: 'Empirical strategy',
    compareP1:
      'To estimate the causal effect of seafarer departures on the literacy gender gap, I use a difference-in-differences approach that exploits variation in the number of seafarer departures across the Dutch Republic. By comparing changes in the literacy gender gap before and after the pre-treatment period of 1600 over two treatment periods, a three-period design allows for identification of the average treatment effect.',
    schematicAria: 'Continuous DiD schematic',
    schematicOutcome: 'Outcome',
    schematicOutcomeBody: 'Change in literacy gender gap (female − male)',
    schematicExposure: 'Exposure',
    schematicExposureBody: 'VOC departures ÷ 1600 population',
    schematicHeld: 'Held fixed',
    schematicHeldBody: 'City FE, year FE, lon/lat × year',
    compareP2:
      'In contrast to the canonical design, I use a continuous treatment variable that allows for comparisons beyond binary distinctions between treated and untreated cities. A continuous difference-in-differences analysis compares across levels of treatment intensity, allowing for an analysis of the case where every city is at least minimally exposed to the VOC.',
    compareP3:
      'To make it more plausible that the conditional parallel trends assumption holds, I include interactions of longitude and latitude with year fixed effects to control for differential trends across cities, while also controlling for population growth to account for the influence of maritime commercial development on literacy gender gap trends.',
    methodsSummary: 'Methods note: TWFE equation & gap sign',
    methodsP1:
      'Baseline form: literacy gender gapᵢ,ₜ = β (Dᵢ × Postₜ) + city FE + year FE + controls × year + εᵢ,ₜ. A flexible form replaces Post with year-specific interactions for 1675 and 1750 (1600 as baseline). Standard errors are clustered by city.',
    methodsP2:
      'Gap = female literacy − male literacy. Positive coefficients are discussed as a closing of women’s disadvantage (the gap becoming less negative / more equal), following the thesis convention.',
    estimatesEyebrow: 'Maritime-induced male absence and the literacy gender gap',
    estimatesH2: 'Results',
    estimatesPHtml:
    ...
    eventCaption:
      'Point estimates with 95% confidence intervals of the flexible specifications with longitude and latitude controls, shown with and without population-growth controls.',
    esX: 'Year',
    ...
    decompMaleP:
      'Male literacy coefficients are not statistically significant in any treatment period, suggesting that female literacy is the sole significant driver behind the closing of the literacy gender gap.',
    fragileEyebrow: 'Robustness checks',
    fragileH2: 'Robustness checks and limitations',
    fragilePHtml:
      'After leaving out Rotterdam, a major outlier in the treatment intensity distribution, all treatment effects become statistically insignificant with far larger standard errors, confirming that the estimated treatment effects are highly driven by Rotterdam. This does not necessarily invalidate the previous results, but due to a lack of data availability gives <strong>little generalisable conclusions</strong> about the true strength of the average treatment effect.',
    limit1Html: '<strong>Small sample.</strong> The sample contains 32 Dutch cities, making support for the conditional parallel trends assumption hard to establish.',
    limit2Html:
      '<strong>Lack of pre-treatment periods.</strong> Pre-trend tests are impossible, making it difficult to argue that the parallel trends assumption is not violated.',
    limit3Html:
      '<strong>Limited time periods.</strong> With more available time periods associated with literacy rates and seafarer departures, heterogeneity-robust difference-in-differences estimators would be required to assess whether the findings remain robust.',
    limit4Html:
      '<strong>Commercial development.</strong> Population growth is controlled for to account for the influence of maritime commercial development on literacy gender gap trends, but consistent statistics for pre-treatment population growth trends do not exist.',
    limit5Html:
      '<strong>External validity.</strong> The data contain only Dutch cities, so the findings do not show whether the effects of seafarer departures are robust to variation in the religious status of cities.',
    readEyebrow: 'Discussion and conclusion',
    readH2: 'Discussion and conclusion',
    readPull:
      'The findings provide suggestive evidence in favour of a salient shock to the adult sex ratio, which divulged into consequences for domestic marriage markets and labour markets that encouraged women to acquire human capital.',
    readP1:
      'This thesis finds that VOC seafarer departures have a significant closing effect on the literacy gender gap. This effect is almost entirely driven by increases in female literacy rather than decreases in male literacy. It is robust to controlling for post-treatment population growth trends, but far less robust to dropping Rotterdam.',
    readP2:
  ...
  nl: {
    metaTitle:
      'Economische autonomie van vrouwen in de Nederlandse Republiek en de door de VOC-veroorzaakte afwezigheid van mannen · Take Watanabe',
    metaDescription:
      'Deze scriptie onderzoekt het causale effect van maritiem veroorzaakte afwezigheid van mannen op de economische autonomie van vrouwen in de vroegmoderne Nederlandse Republiek.',
    navAria: 'Hoofdstukken',
    langAria: 'Taal',
    ...
    heroBegin: 'Volg het bewijs',
    heroPdf: 'Download PDF',
    heroFindingsAria: 'Wat het bewijs suggereert',
    heroFindingsEyebrow: 'Samenvatting',
    heroEstimateAria:
    ...
    globeZoomIn: 'Inzoomen',
    globeZoomOut: 'Uitzoomen',
    globeTypeCorridor: 'Terugkerende corridor',
    globeTypeVoyage: 'Gedocumenteerde reis',
    globePeriodLabel: 'Periode',
    ...
    globeRouteBatavia: 'Batavia, 1628–29',
    globeRouteBataviaDesc:
      'Het VOC-schip Batavia vertrok van Texel naar Java, rondde de Kaap, voer te ver oostwaarts op de zuidelijke oceaancorridor en verging op 4 juni 1629 bij de Houtman Abrolhos.',
    globeRouteJapan: 'Batavia naar Japan',
    globeRouteJapanDesc:
      'De VOC-handel met Japan werd vanuit Batavia bestuurd, eerst via Hirado en later Dejima, met scheepvaart noordwaarts door de Zuid- en Oost-Chinese Zee.',
...
export const supportedLangs = ['en', 'nl'];
